var ggApp = angular.module('groceryGetter',[]);
...
ggApp.controller('TestCtrl',['$scope','$http','geolocation','cordovaReady','cordovaWrapper',function($scope,$http,geolocation,cordovaReady,cordovaWrapper) {
	$scope.data = {
		title: 'Hello World'
	};
...
ggApp.service('cordovaWrapper',[function() {
	var svc = {
		deviceReady: false
		,loaded: false
...
ggApp.factory('geolocation',['$rootScope','cordovaReady',function($rootScope, cordovaReady) {
	return {
...
ggApp.factory('accelerometer',['$rootScope','cordovaReady',function($rootScope, cordovaReady) {
	return {
...
ggApp.factory('cordovaReady', [function() {
	return function (fn) {
...
ggApp.filter('jsonFull', [function () {
...
ggApp.filter('renderHTML', ['$sce', function($sce){
